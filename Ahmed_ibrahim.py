...
red_pwm = GPIO.PWM(redLED,100)                                                                #create PWM instance named "red_pwm" with frequency 1000.
blue_pwm = GPIO.PWM(blueLED,100)                                                              #create PWM instance named "blue_pwm" with frequency 1000.
green_pwm = GPIO.PWM(greenLED,100)                                                            #create PWM instance named "green_pwm" with frequency 1000.
